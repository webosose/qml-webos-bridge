...
#ifndef WEBOSSERVICEPLUGIN_H
#define WEBOSSERVICEPLUGIN_H

#include <QQmlExtensionPlugin>

    /*!
     * \class WebOSServicePlugin
     * \brief Provides all registered services in a plugin.
     *
     * The services are registered in the \a registerTypes() method.
     *
     * \see ApplicationManagerService
     * \see SystemService
     */

class WebOSServicePlugin : public QQmlExtensionPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "com.palm.webosservice" FILE
